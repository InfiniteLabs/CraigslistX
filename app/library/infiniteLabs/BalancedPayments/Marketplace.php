...
use infiniteLabs\BalancedPayments\Errors;
use infiniteLabs\BalancedPayments\Account;
use \RESTful\URISpec;
 ...
 * print $secret;
 * \infiniteLabs\BalancedPayments\Settings::$api_key = $secret;
 *
 * $marketplace = new \infiniteLabs\BalancedPayments\Marketplace();
 * $marketplace->save();
 ...
 * <code>
 * \infiniteLabs\BalancedPayments\Settings::$api_key = $secret;
 * $marketplace = \infiniteLabs\BalancedPayments\Marketplace::mine();  // this is the marketplace associated with $secret
 * </code>
 */
class Marketplace extends \infiniteLabs\BalancedPayments\Resource
{
     ...
     * \infiniteLabs\BalancedPayments\Settings::$api_key.
     *
     * @throws \RESTful\Exceptions\NoResultFound
     * @return \infiniteLabs\BalancedPayments\Marketplace
     */
     ...
     * \infiniteLabs\BalancedPayments\Account->addCard or \infiniteLabs\BalancedPayments\Marketplace->createBuyer.
     *
     ...
     *
     * @return \infiniteLabs\BalancedPayments\Card
     */
     ...
     * using \infiniteLabs\BalancedPayments\Account->addBankAccount.
     *
     ...
     *
     * @return \infiniteLabs\BalancedPayments\BankAccount
     */
     ...
     * \infiniteLabs\BalancedPayments\Account->promoteToMerchant.
     *
