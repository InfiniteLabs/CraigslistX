 ...
 *
 * You create these using infiniteLabs\BalancedPayments\Account::credit.
 *
 * <code>
 * $customer = infiniteLabs\BalancedPayments\Customer::get('CUSTOMER_URI');
 * $customer->credit(100);
 * </code>
 */
class Credit extends \infiniteLabs\BalancedPayments\Resource
{
